...
#define ints(...) int64_t __VA_ARGS__; cp::internal::read(__VA_ARGS__)
#define strs(...) std::string __VA_ARGS__; cp::internal::read(__VA_ARGS__)
#define floats(...) long double __VA_ARGS__; cp::internal::read(__VA_ARGS__)
